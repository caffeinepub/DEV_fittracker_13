...
import { useConfirmationModal, useModal } from "../hooks/useModal";
import {
  useActualSets,
  useCopyWorkout,
  useDeleteWorkout,
...
const Workouts: React.FC<WorkoutsProps> = ({
  onEditWorkout,
  onCreateWorkout: _onCreateWorkout,
}) => {
  ...
  const _getExerciseById = (id: bigint) => {
...
const WorkoutCard: React.FC<{
  ...
  const getPerformanceData = (
    ...
    if (!performanceAndId[1]) return null;
